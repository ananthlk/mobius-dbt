{{
  config(
    ...
    merge_update_columns=[
      'document_id', 'source_type', 'source_id', 'embedding', 'model', 'created_at', 'text',
...
-- Chat-server mart: published RAG embeddings (incremental).
-- Source: landing_rag.rag_published_embeddings. Only new/updated rows merged each run.
-- First run after switching to incremental: run once with --full-refresh to rebuild from landing.
